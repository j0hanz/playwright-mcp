...
export const config: ServerConfig = {
  ...
  screenshot: {
    ...
    quality: parseNumber(
      'SCREENSHOT_QUALITY',
      process.env.SCREENSHOT_QUALITY,
  ...
  timeouts: {
    default: parseNumber(
      'TIMEOUT_DEFAULT',
      process.env.TIMEOUT_DEFAULT,
      DEFAULTS.TIMEOUT_DEFAULT_MS
    ),
    navigation: parseNumber(
      'TIMEOUT_NAVIGATION',
      process.env.TIMEOUT_NAVIGATION,
      DEFAULTS.TIMEOUT_NAVIGATION_MS
    ),
    action: parseNumber(
      'TIMEOUT_ACTION',
      process.env.TIMEOUT_ACTION,
      DEFAULTS.TIMEOUT_ACTION_MS
    ),
    assertion: parseNumber(
      'TIMEOUT_ASSERTION',
      process.env.TIMEOUT_ASSERTION,
      DEFAULTS.TIMEOUT_ASSERTION_MS
    ),
  },
  limits: {
    maxScriptLength: parseNumber(
      'MAX_SCRIPT_LENGTH',
      process.env.MAX_SCRIPT_LENGTH,
      DEFAULTS.MAX_SCRIPT_LENGTH
    ),
    ...
    maxSessionsPerMinute: parseNumber(
      'MAX_SESSIONS_PER_MINUTE',
      process.env.MAX_SESSIONS_PER_MINUTE,
      DEFAULTS.MAX_SESSIONS_PER_MINUTE
    ),
  },
  // Video recording configuration
  video: {
